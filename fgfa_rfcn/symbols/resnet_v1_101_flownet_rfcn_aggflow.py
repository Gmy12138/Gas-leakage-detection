...
class resnet_v1_101_flownet_rfcn(Symbol):
    ...
    def get_train_symbol(self, cfg):
        ...
        flow_feature_1 = self.get_feature_relu(flow[0])
        flow_feature_2 = self.get_feature_relu(flow[1])
        ...
        #low_feature = flow_feature_1 * weight1 +flow_feature_2 * weight2
    ...
    def get_aggregation_symbol(self, cfg):
        ...
        flow1 = mx.sym.SliceChannel(flow1, axis=0, num_outputs=6)
